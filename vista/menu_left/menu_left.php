 <div class="sidebar" data-color="rose" data-background-color="black" data-image="../assets/img/sidebar-1.jpg">
    ...
    <!-- Logo del sistema -->
    <?php include RUTA_SISTEMA . 'vista/menu_left/logo.php';?>
...
<div class="sidebar-wrapper">
    <!-- perifl del usuario -->
    <?php include RUTA_SISTEMA . 'vista/menu_left/perfil_user.php';?>
    <!-- perifl del usuario -->
</div>
            ...
            <li class="nav-item ">
                <a class="nav-link" href="../examples/tables/regular.html">
                        <!-- <span class="sidebar-mini">AU</span>
                            <span class="sidebar-normal">Administrar Usuarios</span> -->


                            <i class="material-icons">group</i>
                            <p> Administrar Usuarios
                                <!-- <b class="caret"></b> -->
                            </p>
